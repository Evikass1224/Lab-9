...
namespace TimeManagement
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            timeKeyboard.Checked += TimeInputChanges;
            systemTime.Checked += TimeInputChanges;
            presentTime.Text = "--:--";
            TimeEntryWindowActivity();
            _currentTime = null;
            _originalTime = null;
        }

        //изменение состояния ввода времени
        private void TimeInputChanges(object sender, RoutedEventArgs e)
        {
            TimeEntryWindowActivity();
        }

        private void TimeEntryWindowActivity()
        {
